//!\file	addonPointyEars.hpp
//!\brief	Naming a shared library that manages logical objects Pointy Ears, is Illogical.
#ifndef ADDONPOINTYEARS_HPP
#define ADDONPOINTYEARS_HPP
