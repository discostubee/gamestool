...
namespace gt{
	...
	protected:
		...
		virtual cByteBuffer& read(const dFilePoint pStartPoint = 0, const size_t pReadAmount = 0 ){ DUMB_REF_ARG(pStartPoint); DUMB_REF_ARG(pReadAmount); DONT_USE_THIS;  cByteBuffer *temp=NULL; return *temp; }

		virtual void write(const cByteBuffer* pBuff){ DUMB_REF_ARG(pBuff); DONT_USE_THIS; }
		...
		virtual void insert(const cByteBuffer* pBuff, dFilePoint pStartSpot){ DUMB_REF_ARG(pBuff); DUMB_REF_ARG(pStartSpot); DONT_USE_THIS; }

		//!\fn		virtual void deleteFile()
		//!\brief	Delete the file.
		virtual void deleteFile(){ DONT_USE_THIS; }

		//!\fn		virtual size_t getFileSize()
		//!\brief	Get the size of a file.
		virtual size_t getFileSize(){ DONT_USE_THIS; return 0; }
	...
	public:
		...
		static void draft(){ tOutline<cBase_fileIO>::draft(); }
